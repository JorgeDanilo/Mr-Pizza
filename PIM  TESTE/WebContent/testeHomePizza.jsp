...
<body>
<form action="testeComprarPizza.jsp" method="get">
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<p><h1 align="center"><b>Produtos mais vendidos</b></h1></p>
			...
			<div class="row">
				<div class="col-sm-2 col-lg-3 col-md-2">
					<div class="thumbnail">
						...
						<div class="caption">
							<h4 name="preco" class="pull-left">R$<%=produto.getPreco_venda() %></h4>
							<h4>	
							<br/>		
								<h4><a name="descricao" href="comprar.jsp"><%=produto.getDescricao() %></a></h4>
							</h4>
							<a href="testeComprarPizza.jsp?&descricao=<%=produto.getDescricao()%>&preco=<%=produto.getPreco_venda()%>&id=<%=produto.getCod_produto()%>"><input type="button" class="btn btn-primary" value="Comprar"/></a>
