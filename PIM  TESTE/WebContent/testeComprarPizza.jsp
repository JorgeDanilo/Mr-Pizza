...
<form action="ControllerPedido" method="post" name="form1" onsubmit="return campoVazio(this)">
<div class="container">
	<table id="cart" class="table table-hover table-condensed">
							...
							<td data-th="Product">
								<div class="row">
									...
									<div class="col-sm-15">
										...
										<input type="hidden" name="desc" id="desc" value="<%=request.getParameter("descricao")%>">
										<p></p>
									</div>
								</div>
							</td>
				...
				<input type="hidden" name="nome" id="nome" value="<%=session.getAttribute("ID") %>"/>
				...
				function voltarParaHome() {
					...
					if (r == true) {
						location.href="http://localhost:8080/PIM__TESTE/testeHomePizza.jsp";
					} else {
				...
				/* function campoVazio(form1) {
					
					var codigocliente = document.getElementById("nome").value;
					var cor = "#FF0000";
					
					if (codigocliente == "" || codigocliente == null) {
						
						alert("Código do cliente vazio.\nFavor preencher com seu codigo");
